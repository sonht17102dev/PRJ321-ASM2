...
%>
	<div class="container">
	    <div class="left">
	      <h1>Sign in</h1>
	      <form name="login-form" action="/PRJ321x-A2x/login"   method="post">
	    ...
	    <div class="right">
	      <div class="content">
	        <h1><%= session.getAttribute("error")==null?"Welcome back!":"Error:" %></h1>
	        <p><%= session.getAttribute("error")==null?"To keep connected with us <br>please login with your personal info":err %></p>
